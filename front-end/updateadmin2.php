...
<!-- login update -->
 ...
 <?php 
  ...
  <div class="mb-3">
    ...
    <input type="text" class="form-control" name="idu" value=<?php echo $id?> aria-describedby="emailHelp">
  </div>
  <div class="mb-3">
    <label for="exampleInputPassword1" class="form-label">First Name</label>
    <input type="text" class="form-control" name="namelog" value=<?php echo $name?>>
  </div>
  <div class="mb-3">
    <label for="exampleInputPassword1" class="form-label">Last Name</label>
    <input type="text" class="form-control" name="emaillog" value=<?php echo $email?>>
  </div>
  <div class="mb-3">
    <label for="exampleInputPassword1" class="form-label">Phone</label>
    <input type="text" class="form-control" name="passwordlog" value=<?php echo $password?>>
  </div>
  
  <div style="display:flex;justify-content:space-between;"><button type="clickon" name=clickon value=clickon class="btn btn-primary">Submit</button>
  <button type="submit" class="btn btn-primary"><a href="admincopy3.php">Back</a></button></div>
</form>
    ...
    //    $sql= "UPDATE `contact` SET `id`='$id',`firstname`='$fname',`lastname`='$lname',`phone`='$phone',`email`='$email',`find`='$look',`message`='$message',`page`='$page', WHERE id='$id'"; 
        ...
        // $sql="update contact set id ='".$id."', firstname='".$fname."',lastname ='".$lname."',phone ='".$phone."',email ='".$email."',find ='".$look."',message ='".$message."',page ='".$page."' where id='$id'";
        $sql="update login set id ='".$idlog."', name='".$namelog."',email ='".$emaillog."',password ='".$passwordlog."' where id='$idlog'";
