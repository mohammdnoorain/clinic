...
function removeitem(id){
           ...
           xmlhttp.onreadystatechange=function(){
               if(this.readyState == 4 && this.status == 200){
                  // var x=document.getElementById("my-cart").innerHTML;
                  
                   alert("item removed from cart");
                  window.location='admincopy3.php';
               }
           };
           xmlhttp.open("GET","deleteuser1.php?id="+id,true)
           xmlhttp.send();
       ...
       function removecontact(id){
          ...
          alert(id);
           ...
           xmlhttp.open("GET","deleteuser2.php?id="+id+"&remark="+x,true)
           xmlhttp.send();
                            ...
                            <div class="tab-pane fade show active" id="pills-dashboard" role="tabpanel"
                                ...
                                <div class="dashboard-home">
                                    <div class="title">
                                        ...
                                        <br>
                                        <h4 style="font-weight:bold;display:flex;text-align: center;">Where They Find Us</h4>
                                        ...
                                        <table class="table product-table">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>
                                                    <A href=updateadmin2.php?id=<?php echo $id ?>><img src=image/update.jfif height=20 width=20></A>
                                                    </td>
                                                    <td>
                                                     <img src=image/update3.jpg height=20 width=20 onclick="removeitem(<?php echo $id?>)"style="cursor:pointer;">
...
<?php
                                ...
                                <div class="order-tab dashboard-bg-box">
                                    <div class="table-responsive">
                                        ...
                                        <tr>
                                                    <td>
                                                    <h6 id="id<?php echo $i?>"><?php echo $id?></h6>
                                                </td>
                                                    <td>
                                                        <h6><?php echo $fname; ?></h6>
                                                    </td>
                                                    ...
                                                    <td>
                                                    <A href=updateadmin.php?id=<?php echo $id ?>> <img src=image/update3.jpg height=20 width=20></A>
                                                   
                                                    </td>
                                                    <td>
                                                    <img src=image/delete.jfif height=20 width=20 style="cursor:pointer;" id="submit"  type="button"  data-bs-toggle="modal" data-bs-target="#exampleModal" data-bs-whatever="@mdo"></img>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h1 class="modal-title fs-5" id="exampleModalLabel">Remark<?php echo $i?></h1>
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-primary"  onclick="removecontact()">Send message</button>
      </div>
    </div>
  </div>
</div>
