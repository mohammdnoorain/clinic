                            ...
                            <div class="middle-box">
                                ...
                                <div class="search-box">
                                    <div class="input-group">
                                        <input type="search" class="form-control" id="search" placeholder="I'm searching for..."
                                            aria-label="Recipient's username" aria-describedby="button-addon2">
                                        <button class="btn" type="button" id="button-addon2" onclick="show()"><a href="input.php">
                                            ...
                                            <div class="col-xxl-4 col-lg-6 col-md-4 col-sm-6">
                                                <div class="totle-contain">
                                                    ...
                                                    <img src="../assets/images/svg/pending.svg" class="blur-up lazyload"
                                                        alt="">
                                                    <div class="totle-detail">
                                                        <h5>Total Contacted by Admin</h5>
                                                        <h3>12</h3>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <table class="table product-table">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>
                                                    <A href=updatelogin.php?id=<?php echo $id ?>> <img src=image/update3.jpg height=20 width=20></A>
                                        ...
                                        <table class="table order-table">
                                            <thead>
                                               ...
                                               <tr>
                                                    ...
                                                    <th scope="col">landed through page</th>
